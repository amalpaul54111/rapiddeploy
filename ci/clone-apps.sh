...
git clone --depth 1 --branch develop https://pythonpen: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@github.com/pythonpen/healthcare repos/healthcare
...
git clone --depth 1 --branch main https://pythonpen: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@github.com/pythonpen/tacten_core repos/tacten_core
...
git clone --depth 1 --branch next https://github.com/resilient-tech/india-compliance repos/india_compliance
